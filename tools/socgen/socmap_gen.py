...
def print_constants(fp, soc, esp_config):
  ...
  fp.write("  ------ Security features enable\n")
  fp.write("  constant CFG_SECURITY         : std_ulogic := \'" + str(soc.noc.enable_security.get()) + "\';\n")
  fp.write("  constant CFG_RD_BASE_ADDR_1   : unsigned(32-1 downto 0) := X\"A0100B30\";\n")
  fp.write("  constant CFG_RD_RANGE_SIZE_1  : unsigned(32-1 downto 0) := X\"00001000\";\n")
  fp.write("  constant CFG_RD_BASE_ADDR_2   : unsigned(32-1 downto 0) := X\"A0102340\";\n")
  fp.write("  constant CFG_RD_RANGE_SIZE_2  : unsigned(32-1 downto 0) := X\"00100000\";\n")
  fp.write("  constant CFG_WR_BASE_ADDR_1   : unsigned(32-1 downto 0) := X\"A0100B30\";\n")
  fp.write("  constant CFG_WR_RANGE_SIZE_1  : unsigned(32-1 downto 0) := X\"00001000\";\n")
  fp.write("  constant CFG_WR_BASE_ADDR_2   : unsigned(32-1 downto 0) := X\"A0102340\";\n")
  fp.write("  constant CFG_WR_RANGE_SIZE_2  : unsigned(32-1 downto 0) := X\"00100000\";\n")
...
def print_mapping(fp, soc, esp_config):
  ...
  #
  fp.write(" -- Get accelerator tile IDs\n")
  pos = 0
  fp.write("  constant acc_tile_id_vec : attribute_vector(0 to  accelerators_num - 1) := (\n")
  for i in range(0, esp_config.ntiles):
    t = esp_config.tiles[i]
    if t.acc.id != -1:
      fp.write("    " + str(pos) + " => " + str(i) + ",\n")
      pos += 1
  fp.write("    others => 0);\n\n")
